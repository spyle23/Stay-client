 ...
 *
 * `placeholderData: keepPreviousData` (story 1.8, AC-9) : lors d'un changement de
 * filtre/tri (nouvelle clé de query), la grille précédente reste visible pendant le
 * re-fetch au lieu d'un flash de skeletons — mise à jour fluide, sans blocage.
 */
